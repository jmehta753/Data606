---
title: "DATA606 Lab4a - Foundations for statistical inference - Sampling distributions"
author: "JM"
date: "May 24, 2017"
output:
  html_document:
...
#### This distribution is positively skewed, with a long tail on right side.
...
#### This distribution is not showing characteritsics of normal distribution or even the population distribution. There seem to be fat tails on both left and right side, compared to population which had only a thin tail on right side.
...
#### The mean of the sample is different from sample1 but seen in context of population std deviation, it is always within a ***fraction of 1 std deviation***.
...
#### There are 5000 elements in sample_means50. The distribution is nearly normal. With a larger sample size we dont expect much changes as the sample size is already significant. We can expect some minor improvements in estimates with that.
...
#### There are 100 elements in this vector. Each element is a sample estimate of mean for area.
...
#### When the sample sizes are larger there are more observations concentrated in the center indicating that outlier estimates are getting eliminated. This implies better estimation of mean.
