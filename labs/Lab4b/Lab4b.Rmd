---
title: "DATA606 Lab4b - Foundations for statistical inference - Confidence intervals"
author: "JM"
date: "May 24, 2017"
output:
  html_document:
...
#### The typical size would be around 1550. The 'typical' here implies average or mean size.


2.  Would you expect another student's distribution to be identical to yours? 
Would you expect it to be similar? Why or why not?

#### No it would not be exactly same as the samples generated would be different. Though some similarities can be expected as the sample size is big enough.
...
#### The conditions needed are - 1) independence of observations (statistican should know if they are independent and also the sample size should be less than 10% of population), 2) Number of observations to be atleast 30, and 3) the distributions should not have a skew. (moderate skew allowed for large sample sizes)

## Confidence levels

4.  What does "95% confidence" mean? If you're not sure, see Section 4.2.2.

#### It implies that if we take 100 samples and derive intervals from it, the point estimate would lie within atleast 95 of those intervals.
...
#### Yes the average size is captured. N/A for neighbour.
...
#### We expect 95% of the intervals to contain the true population mean. As this is what 95% confidence interval derivation conveys.
